...
syntax cluster luaExpr contains=@luaBase,luaTable,luaSpecialTable,luaSpecialValue,luaOperator,luaSymbolOperator,luaEllipsis,luaComma,luaFunc,luaFuncCall
...
" Function Name
syntax match luaFuncName "\(\<function\>\)\@<=\s\+\S\+\s*(\@="
